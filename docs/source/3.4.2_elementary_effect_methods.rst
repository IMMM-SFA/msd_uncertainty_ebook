...
with r representing the number of repetitions (or trajectories) in the input space, usually set between 4 and 10 :cite:p:`saltelli2004sensitivity`. Each xj represents the points of each trajectory, with j=1,…, r, selected as described in the sampling strategy for this method, found above. This method also produces the standard deviation of the EEs:
