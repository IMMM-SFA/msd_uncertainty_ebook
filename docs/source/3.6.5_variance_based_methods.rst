...
The first-order sensitivity index indicates the percent of model output variance contributed by a factor individually (i.e., the effect of varying xi alone) and is obtained using the following :cite:p:`sobol2001global,saltelli2002making`. 
