...
.. note:: Run the tutorial interactively:  `Logistic Regression Tutorial <https://hub-binder.mybinder.ovh/user/immm-sfa-msd_uncertainty_ebook-pheczmlw/notebooks/notebooks/basin_users_logistic_regression.ipynb>`_
