...
`2.2 - Sensitivity analysis for one output <#sa_metrics>`__

`2.3 - Sensitivity analysis across multiple outputs <#diff_performance>`__

`2.4 - Time-varying sensitivity analysis <#TVSA>`__
