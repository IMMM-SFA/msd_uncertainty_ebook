...
from matplotlib.colorbar import colorbar #import colorbar to fix colorbar type
...
def sample_data():
    ...
    profit_solution = 1
    robust_solution = 2
    param_values = np.random.rand(100, 7)  # Example data
    collapse_days = np.random.rand(100, 2) * 10  # Example data
